...
class ProcessingRegistry:
    """
    JSON-based processing registry for the Phase 1 POC.
    ...
    def save(
        ...
        """
        Save registry atomically using a temporary file.
        """
    ...
    def get(
        ...
        """
        Return an existing registry record.
        """
    ...
    def is_completed(
        ...
        """
        Check whether processing has completed.

        When verify_output=True, the canonical
        normalized JSON must also exist.
        """
    ...
    def mark_processing(
        ...
        """
        Mark a document/scope as currently processing.
        """
    ...
    def add_or_update(
        ...
        """
        Insert or replace one registry record.
        """
